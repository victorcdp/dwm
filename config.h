...
static const int focusonwheel       = 0;  /* from focus on click */
...
static Key keys[] = {
	...
	{ MODKEY,			XK_w,		spawn,		SHCMD("setbg ~/pictures/wallpapers") },
	...
	{ MODKEY,			XK_m,		spawn,		SHCMD(TERMINAL "pidof ashuffle && pkill ashuffle && mpc clear || ashuffle") },
