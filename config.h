...
/* --------------- settings -------------- */
static const char *fonts[]      = { "JetBrainsMono Nerd Font:style=medium:size=7", "monospace:size=7" };
...
/* --------------- defaults -------------- */
#define APP_BROWSER             "brave"
#define APP_BROWSER_            "brave --incognito"
...
static const char vol_up[]      =  "pamixer -i 2; kill -44 $(pidof dwmblocks)" ;
static const char vol_down[]    =  "pamixer -d 2; kill -44 $(pidof dwmblocks)" ;
static const char vol_mute[]    =  "pamixer -t; kill -44 $(pidof dwmblocks)";
